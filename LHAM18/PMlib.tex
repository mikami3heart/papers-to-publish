...
arithmetic type. %, which is rather strong assumption.
...
% The mapping of mathematical functions to native instructions can be complicated,
% since it depends not only on the system architecture, but also on the compilers.
